...
public class RecipeTest {
	...
	public void testUpdateRecipe() {
		...
		Assertions.assertEquals(updatedRecipe.getIngredients(), retrievedRecipe.getIngredients(),
				"The ingredients of the retrieved recipe should match the updated ones");
